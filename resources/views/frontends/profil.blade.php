                ...
                <div class="block-content">
                    <form action="{{route('profil.update')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="no_induk" value="{{$user->no_induk}}"  required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="example-select" name="gender">
                                <option value="1" {{$user->gender? 'selected':''}} >laki-laki</option>
                                <option value="0" {{$user->gender? '':'selected'}}>perempuan</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="block">
                ...
                <div class="block-content">
                    <form action="{{route('password.update')}}" method="POST" class="validatedForm">
                        @csrf
                        <div class="form-group">
